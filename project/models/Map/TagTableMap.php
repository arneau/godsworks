...
class TagTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('KeywordId', 'TypeId', 'VerseId', 'Id', ),
        self::TYPE_CAMELNAME     => array('keywordId', 'typeId', 'verseId', 'id', ),
        self::TYPE_COLNAME       => array(TagTableMap::COL_KEYWORD_ID, TagTableMap::COL_TYPE_ID, TagTableMap::COL_VERSE_ID, TagTableMap::COL_ID, ),
        self::TYPE_FIELDNAME     => array('keyword_id', 'type_id', 'verse_id', 'id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('KeywordId' => 0, 'TypeId' => 1, 'VerseId' => 2, 'Id' => 3, ),
        self::TYPE_CAMELNAME     => array('keywordId' => 0, 'typeId' => 1, 'verseId' => 2, 'id' => 3, ),
        self::TYPE_COLNAME       => array(TagTableMap::COL_KEYWORD_ID => 0, TagTableMap::COL_TYPE_ID => 1, TagTableMap::COL_VERSE_ID => 2, TagTableMap::COL_ID => 3, ),
        self::TYPE_FIELDNAME     => array('keyword_id' => 0, 'type_id' => 1, 'verse_id' => 2, 'id' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('TagType', '\\TagType', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':type_id',
    1 => ':id',
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(TagTableMap::COL_TYPE_ID);
