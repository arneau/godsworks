...
/**
 * Base class that represents a row from the 'tag_type' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class TagType implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\TagTypeTableMap';
    ...
    /**
     * Initializes internal state of Base\TagType object.
     */
    ...
    /**
     * Compares this with another <code>TagType</code> instance.  If
     * <code>obj</code> is an instance of <code>TagType</code>, delegates to
     * <code>equals(TagType)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|TagType The current object, for fluid interface
     */
     ...
     * @return $this|\TagType The current object (for fluent API support)
     */
    public function setValue($v)
    {
        ...
        if ($this->value !== $v) {
            $this->value = $v;
            $this->modifiedColumns[TagTypeTableMap::COL_VALUE] = true;
        }
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[TagTypeTableMap::COL_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : TagTypeTableMap::translateFieldName('Value', TableMap::TYPE_PHPNAME, $indexType)];
            $this->value = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : TagTypeTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = TagTypeTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\TagType'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildTagTypeQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see TagType::setDeleted()
     * @see TagType::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildTagTypeQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TagTypeTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(TagTypeTableMap::COL_VALUE)) {
            $modifiedColumns[':p' . $index++]  = 'value';
        }
        if ($this->isColumnModified(TagTypeTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }

        $sql = sprintf(
            'INSERT INTO tag_type (%s) VALUES (%s)',
    ...
    {
        $pos = TagTypeTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['TagType'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['TagType'][$this->hashCode()] = true;
        $keys = TagTypeTableMap::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TagTypeTableMap::COL_VALUE)) {
            $criteria->add(TagTypeTableMap::COL_VALUE, $this->value);
        }
        if ($this->isColumnModified(TagTypeTableMap::COL_ID)) {
     ...
     * objects.
     *
     * @param      object $copyObj An object of \TagType (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \TagType Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildTagType is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildTagType The current object (for fluent API support)
     */
    ...
    {
        return (string) $this->exportTo(TagTypeTableMap::DEFAULT_STRING_FORMAT);
    }
