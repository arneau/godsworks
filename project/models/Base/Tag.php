...
abstract class Tag implements ActiveRecordInterface
{
    ...
    public function setTypeId($v)
    {
        ...
        if ($this->type_id !== $v) {
            $this->type_id = $v;
            $this->modifiedColumns[TagTableMap::COL_TYPE_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : TagTableMap::translateFieldName('TypeId', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(TagTableMap::COL_TYPE_ID)) {
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aTagType) {
                ...
                $result[$key] = $this->aTagType->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
            if (null !== $this->aVerse) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TagTableMap::COL_TYPE_ID)) {
            $criteria->add(TagTableMap::COL_TYPE_ID, $this->type_id);
        }
        if ($this->isColumnModified(TagTableMap::COL_VERSE_ID)) {
    ...
    /**
     * Declares an association between this object and a ChildTagType object.
     *
     * @param  ChildTagType $v
     * @return $this|\Tag The current object (for fluent API support)
     * @throws PropelException
     */
    public function setTagType(ChildTagType $v = null)
    {
        if ($v === null) {
            $this->setTypeId(NULL);
        } else {
        ...
        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the ChildTagType object, it will not be re-added.
        if ($v !== null) {
            $v->addTag($this);
        }
