 ...
 *
 *
 * @method     ChildKeywordQuery orderByValue($order = Criteria::ASC) Order by the value column
 * @method     ChildKeywordQuery orderById($order = Criteria::ASC) Order by the id column
 *
 * @method     ChildKeywordQuery groupByValue() Group by the value column
 ...
 *
 * @method     ChildKeywordQuery leftJoinKeywordSynonym($relationAlias = null) Adds a LEFT JOIN clause to the query using the KeywordSynonym relation
 * @method     ChildKeywordQuery rightJoinKeywordSynonym($relationAlias = null) Adds a RIGHT JOIN clause to the query using the KeywordSynonym relation
 * @method     ChildKeywordQuery innerJoinKeywordSynonym($relationAlias = null) Adds a INNER JOIN clause to the query using the KeywordSynonym relation
 *
 * @method     ChildKeywordQuery joinWithKeywordSynonym($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the KeywordSynonym relation
 *
 * @method     ChildKeywordQuery leftJoinWithKeywordSynonym() Adds a LEFT JOIN clause and with to the query using the KeywordSynonym relation
 * @method     ChildKeywordQuery rightJoinWithKeywordSynonym() Adds a RIGHT JOIN clause and with to the query using the KeywordSynonym relation
 * @method     ChildKeywordQuery innerJoinWithKeywordSynonym() Adds a INNER JOIN clause and with to the query using the KeywordSynonym relation
 *
 * @method     ChildKeywordQuery leftJoinTag($relationAlias = null) Adds a LEFT JOIN clause to the query using the Tag relation
 * @method     ChildKeywordQuery rightJoinTag($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Tag relation
 * @method     ChildKeywordQuery innerJoinTag($relationAlias = null) Adds a INNER JOIN clause to the query using the Tag relation
 *
 * @method     ChildKeywordQuery joinWithTag($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Tag relation
 *
 * @method     ChildKeywordQuery leftJoinWithTag() Adds a LEFT JOIN clause and with to the query using the Tag relation
 * @method     ChildKeywordQuery rightJoinWithTag() Adds a RIGHT JOIN clause and with to the query using the Tag relation
 * @method     ChildKeywordQuery innerJoinWithTag() Adds a INNER JOIN clause and with to the query using the Tag relation
 *
 * @method     \KeywordSynonymQuery|\TagQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 *
 * @method     ChildKeyword findOneByValue(string $value) Return the first ChildKeyword filtered by the value column
 ...
 *
 * @method     ChildKeyword requireOneByValue(string $value) Return the first ChildKeyword filtered by the value column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildKeyword[]|ObjectCollection findByValue(string $value) Return ChildKeyword objects filtered by the value column
...
abstract class KeywordQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Base\KeywordQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Keyword', $modelAlias = null)
    {
    ...
    public function filterByValue($value = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(KeywordTableMap::COL_VALUE, $value, $comparison);
    }
    ...
    /**
     * Filter the query by a related \KeywordSynonym object
     *
     * @param \KeywordSynonym|ObjectCollection $keywordSynonym the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildKeywordQuery The current query, for fluid interface
     */
    public function filterByKeywordSynonym($keywordSynonym, $comparison = null)
    {
        if ($keywordSynonym instanceof \KeywordSynonym) {
            return $this
                ->addUsingAlias(KeywordTableMap::COL_ID, $keywordSynonym->getKeywordId(), $comparison);
        } elseif ($keywordSynonym instanceof ObjectCollection) {
            return $this
                ->useKeywordSynonymQuery()
                ->filterByPrimaryKeys($keywordSynonym->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterByKeywordSynonym() only accepts arguments of type \KeywordSynonym or Collection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the KeywordSynonym relation
     *
     ...
     * @return $this|ChildKeywordQuery The current query, for fluid interface
     */
    public function joinKeywordSynonym($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('KeywordSynonym');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'KeywordSynonym');
        }
    ...
    /**
     * Use the KeywordSynonym relation KeywordSynonym object
     *
     * @see useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \KeywordSynonymQuery A secondary query class using the current class as primary query
     */
    public function useKeywordSynonymQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinKeywordSynonym($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'KeywordSynonym', '\KeywordSynonymQuery');
    }
    ...
    public function filterByTag($tag, $comparison = null)
    {
        if ($tag instanceof \Tag) {
            return $this
                ->addUsingAlias(KeywordTableMap::COL_ID, $tag->getKeywordId(), $comparison);
