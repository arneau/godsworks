...
abstract class Book implements ActiveRecordInterface
{
    ...
    /**
     * The value for the number_of_chapters field.
     *
     * @var        int
     */
    protected $number_of_chapters;

    /**
     * The value for the number_of_verses field.
     *
     * @var        int
     */
    protected $number_of_verses;
    ...
    /**
     * Get the [number_of_chapters] column value.
     *
     * @return int
     */
    ...
    /**
     * Get the [number_of_verses] column value.
     *
     * @return int
     */
    ...
    /**
     * Set the value of [number_of_chapters] column.
     *
     * @param int $v new value
     * @return $this|\Book The current object (for fluent API support)
     */
    public function setNumberOfChapters($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->number_of_chapters !== $v) {
            $this->number_of_chapters = $v;
            $this->modifiedColumns[BookTableMap::COL_NUMBER_OF_CHAPTERS] = true;
        }
    ...
    /**
     * Set the value of [number_of_verses] column.
     *
     * @param int $v new value
     * @return $this|\Book The current object (for fluent API support)
     */
    public function setNumberOfVerses($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->number_of_verses !== $v) {
            $this->number_of_verses = $v;
            $this->modifiedColumns[BookTableMap::COL_NUMBER_OF_VERSES] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : BookTableMap::translateFieldName('NumberOfChapters', TableMap::TYPE_PHPNAME, $indexType)];
            $this->number_of_chapters = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : BookTableMap::translateFieldName('NumberOfVerses', TableMap::TYPE_PHPNAME, $indexType)];
            $this->number_of_verses = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : BookTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(BookTableMap::COL_NUMBER_OF_CHAPTERS)) {
            $modifiedColumns[':p' . $index++]  = 'number_of_chapters';
        }
        if ($this->isColumnModified(BookTableMap::COL_NUMBER_OF_VERSES)) {
            $modifiedColumns[':p' . $index++]  = 'number_of_verses';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'number_of_chapters':
                        $stmt->bindValue($identifier, $this->number_of_chapters, PDO::PARAM_INT);
                        break;
                    case 'number_of_verses':
                        $stmt->bindValue($identifier, $this->number_of_verses, PDO::PARAM_INT);
                        break;
                    case 'id':
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                return $this->getNumberOfChapters();
                break;
            case 2:
                return $this->getNumberOfVerses();
                break;
            case 3:
                return $this->getId();
                break;
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            $keys[0] => $this->getName(),
            $keys[1] => $this->getNumberOfChapters(),
            $keys[2] => $this->getNumberOfVerses(),
            $keys[3] => $this->getId(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                $this->setNumberOfChapters($value);
                break;
            case 2:
                $this->setNumberOfVerses($value);
                break;
            case 3:
                $this->setId($value);
                break;
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setNumberOfChapters($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setNumberOfVerses($arr[$keys[2]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BookTableMap::COL_NUMBER_OF_CHAPTERS)) {
            $criteria->add(BookTableMap::COL_NUMBER_OF_CHAPTERS, $this->number_of_chapters);
        }
        if ($this->isColumnModified(BookTableMap::COL_NUMBER_OF_VERSES)) {
            $criteria->add(BookTableMap::COL_NUMBER_OF_VERSES, $this->number_of_verses);
        }
        if ($this->isColumnModified(BookTableMap::COL_ID)) {
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setNumberOfChapters($this->getNumberOfChapters());
        $copyObj->setNumberOfVerses($this->getNumberOfVerses());
    ...
    public function initVerses($overrideExisting = true)
    {
        ...
        $this->collVerses = new ObjectCollection();
    ...
    {
        $this->name = null;
        $this->number_of_chapters = null;
        $this->number_of_verses = null;
        $this->id = null;
        $this->alreadyInSave = false;
        $this->clearAllReferences();
        $this->resetModified();
    ...
    // number_of_chapters_aggregate behavior

    /**
     * Computes the value of the aggregate column number_of_chapters *
     * @param ConnectionInterface $con A connection object
     *
     * @return mixed The scalar result from the aggregate query
     */
    public function computeNumberOfChapters(ConnectionInterface $con)
    {
        $stmt = $con->prepare('SELECT COUNT(DISTINCT(chapter_number)) FROM verse WHERE verse.BOOK_ID = :p1');
    ...
    /**
     * Updates the aggregate column number_of_chapters *
     * @param ConnectionInterface $con A connection object
     */
    public function updateNumberOfChapters(ConnectionInterface $con)
    {
        $this->setNumberOfChapters($this->computeNumberOfChapters($con));
        $this->save($con);
    }

    // number_of_verses_aggregate behavior

    /**
     * Computes the value of the aggregate column number_of_verses *
     * @param ConnectionInterface $con A connection object
     *
     * @return mixed The scalar result from the aggregate query
     */
    public function computeNumberOfVerses(ConnectionInterface $con)
    {
        $stmt = $con->prepare('SELECT COUNT(verse_number) FROM verse WHERE verse.BOOK_ID = :p1');
        $stmt->bindValue(':p1', $this->getId());
        $stmt->execute();
    ...
    /**
     * Updates the aggregate column number_of_verses *
     * @param ConnectionInterface $con A connection object
     */
    public function updateNumberOfVerses(ConnectionInterface $con)
    {
        $this->setNumberOfVerses($this->computeNumberOfVerses($con));
        $this->save($con);
    }
