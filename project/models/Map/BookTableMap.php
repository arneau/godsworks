...
class BookTableMap extends TableMap
{
    ...
    /**
     * the column name for the number_of_chapters field
     */
    const COL_NUMBER_OF_CHAPTERS = 'book.number_of_chapters';

    /**
     * the column name for the number_of_verses field
     */
    const COL_NUMBER_OF_VERSES = 'book.number_of_verses';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Name', 'NumberOfChapters', 'NumberOfVerses', 'Id', ),
        self::TYPE_CAMELNAME     => array('name', 'numberOfChapters', 'numberOfVerses', 'id', ),
        self::TYPE_COLNAME       => array(BookTableMap::COL_NAME, BookTableMap::COL_NUMBER_OF_CHAPTERS, BookTableMap::COL_NUMBER_OF_VERSES, BookTableMap::COL_ID, ),
        self::TYPE_FIELDNAME     => array('name', 'number_of_chapters', 'number_of_verses', 'id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Name' => 0, 'NumberOfChapters' => 1, 'NumberOfVerses' => 2, 'Id' => 3, ),
        self::TYPE_CAMELNAME     => array('name' => 0, 'numberOfChapters' => 1, 'numberOfVerses' => 2, 'id' => 3, ),
        self::TYPE_COLNAME       => array(BookTableMap::COL_NAME => 0, BookTableMap::COL_NUMBER_OF_CHAPTERS => 1, BookTableMap::COL_NUMBER_OF_VERSES => 2, BookTableMap::COL_ID => 3, ),
        self::TYPE_FIELDNAME     => array('name' => 0, 'number_of_chapters' => 1, 'number_of_verses' => 2, 'id' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('number_of_chapters', 'NumberOfChapters', 'INTEGER', false, null, null);
        $this->addColumn('number_of_verses', 'NumberOfVerses', 'INTEGER', false, null, null);
  ...
  array (
    ...
    {
        return array(
            'number_of_chapters_aggregate' => array('name' => 'number_of_chapters', 'expression' => 'COUNT(DISTINCT(chapter_number))', 'condition' => '', 'foreign_table' => 'verse', 'foreign_schema' => '', ),
            'number_of_verses_aggregate' => array('name' => 'number_of_verses', 'expression' => 'COUNT(verse_number)', 'condition' => '', 'foreign_table' => 'verse', 'foreign_schema' => '', ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(BookTableMap::COL_NUMBER_OF_CHAPTERS);
            $criteria->addSelectColumn(BookTableMap::COL_NUMBER_OF_VERSES);
            $criteria->addSelectColumn(BookTableMap::COL_ID);
        } else {
            $criteria->addSelectColumn($alias . '.name');
            $criteria->addSelectColumn($alias . '.number_of_chapters');
            $criteria->addSelectColumn($alias . '.number_of_verses');
