...
*/
abstract class Bible implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\BibleTableMap';
    ...
    /**
     * Compares this with another <code>Bible</code> instance.  If
     * <code>obj</code> is an instance of <code>Bible</code>, delegates to
     * <code>equals(Bible)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Bible The current object, for fluid interface
     */
    ...
    public function setCode($v)
    {
        ...
        if ($this->code !== $v) {
            $this->code = $v;
            $this->modifiedColumns[BibleTableMap::COL_CODE] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[BibleTableMap::COL_NAME] = true;
        }
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[BibleTableMap::COL_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : BibleTableMap::translateFieldName('Code', TableMap::TYPE_PHPNAME, $indexType)];
            $this->code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : BibleTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : BibleTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = BibleTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Bible'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildBibleQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildBibleQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                BibleTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(BibleTableMap::COL_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'code';
        }
        if ($this->isColumnModified(BibleTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(BibleTableMap::COL_ID)) {
    ...
    {
        $pos = BibleTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Bible'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Bible'][$this->hashCode()] = true;
        $keys = BibleTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getCode(),
            $keys[1] => $this->getName(),
            $keys[2] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BibleTableMap::COL_CODE)) {
            $criteria->add(BibleTableMap::COL_CODE, $this->code);
        }
        if ($this->isColumnModified(BibleTableMap::COL_NAME)) {
            $criteria->add(BibleTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(BibleTableMap::COL_ID)) {
            $criteria->add(BibleTableMap::COL_ID, $this->id);
        }
    ...
    {
        $criteria = ChildBibleQuery::create();
        $criteria->add(BibleTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Bible (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Bible Clone of current object.
     * @throws PropelException
     */
     ...
     * @return ObjectCollection|ChildPassage[] List of ChildPassage objects
     */
    public function getPassagesJoinVerse(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildPassageQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(BibleTableMap::DEFAULT_STRING_FORMAT);
    }
